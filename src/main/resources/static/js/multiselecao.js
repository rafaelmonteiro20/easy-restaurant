...
Easy.MultiSelecao = (function() {
	...
	function onSelecaoClicado() {
		var selecionados = this.selecaoCheckbox.filter(':checked');
		this.selecaoTodosCheckbox.prop('checked', selecionados.length >= this.selecaoCheckbox.length);
		statusBotaoAcao.call(this, selecionados.length);
	}
